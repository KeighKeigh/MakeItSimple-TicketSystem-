                ...
                var results = ticketConcernQuery
                    .Select(x => new GetOpenTicketResult
                    {
                        ...
                        Ticket_Status = x.IsApprove == false && x.OnHold == null ? TicketingConString.PendingRequest
                                        ...
                                        : x.IsTransfer == false && x.OnHold == null && x.TransferTicketConcerns.First().TransferTo == request.UserId ? TicketingConString.ForTransfer
                                        : x.IsTransfer == false && x.OnHold == null && x.TransferTicketConcerns.First().TransferBy == request.UserId ? TicketingConString.TransferApproval
