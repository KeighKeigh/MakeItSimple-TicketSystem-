    ...
    public class SyncCompany
    {
        ...
        public class Handler : IRequestHandler<SyncCompanyCommand, Result>
        {
            ...
            public async Task<Result> Handle(SyncCompanyCommand command, CancellationToken cancellationToken)
            {
                ...
                var AvailableSync = new List<CompanyResultCommand>();
                var UpdateSync = new List<CompanyResultCommand>();
                var DuplicateSync = new List<CompanyResultCommand>();
                var CompanyCodeNullOrEmpty = new List<CompanyResultCommand>();
                var CompanyNameNullOrEmpty = new List<CompanyResultCommand>();
