...
namespace MakeItSimple.WebApi.DataAccessLayer.Features.CQRS.Setup.SubUnitSetup
{
    public class SyncSubUnit
    {
        ...
        public class Handler : IRequestHandler<SyncSubUnitCommand, Result>
        {
            ...
            {
                var AllInputSync = new List<SyncSubUnitsResult>();
                var AvailableSync = new List<SyncSubUnitsResult>();
                var UpdateSync = new List<SyncSubUnitsResult>();
                var DuplicateSync = new List<SyncSubUnitsResult>();
                var SubUnitCodeNullOrEmpty = new List<SyncSubUnitsResult>();
                var SubUnitNameNullOrEmpty = new List<SyncSubUnitsResult>();
                var UnitNotExist = new List<SyncSubUnitsResult>();
