...
namespace MakeItSimple.WebApi.Migrations
{
    ...
    [Migration("20241111145704_removephase2")]
    partial class removephase2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Setup.QuestionCategorySetup.QuestionCategory", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_question_category");

                    b.HasIndex("AddedByUserId")
                        .HasDatabaseName("ix_question_category_added_by_user_id");

                    b.HasIndex("FormId")
                        .HasDatabaseName("ix_question_category_form_id");

                    b.HasIndex("ModifiedByUserId")
                        .HasDatabaseName("ix_question_category_modified_by_user_id");
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Setup.QuestionCategorySetup.QuestionCategory", b =>
                {
                    b.HasOne("MakeItSimple.WebApi.Models.User", "AddedByUser")
                        ...
                        .HasConstraintName("fk_question_category_users_added_by_user_id");
                    ...
                    b.HasOne("MakeItSimple.WebApi.Models.Setup.FormSetup.Form", "Form")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_question_category_forms_form_id");

                    b.HasOne("MakeItSimple.WebApi.Models.User", "ModifiedByUser")
                        .WithMany()
                        .HasForeignKey("ModifiedByUserId")
                        .HasConstraintName("fk_question_category_users_modified_by_user_id");
